...
definePageMeta({
  ...
  layout: 'default',
  siteName : 'Takdecor - Inregistrare',
  canonicalUrl : process.env.NODE_ENV === 'development' ? 'http://localhost:3000/register' : 'https://texxshop.ro/register',
  ogType : 'website',
  ogDescription : 'Inregistreaza-te pe Takdecor. Totul la un click distanta de cuvertura ta preferata.',
  description : 'Fa-ti cont nou pe Takdecor. Totul la un click distanta de cuvertura/draperiea/perdeaua ta preferata.'
})
