...
definePageMeta({
  ...
  keywords: [
    'creare cont magazin online', 'înregistrează-te și primești reduceri', 'cont nou reduceri exclusive',
    'crează un cont și economisește', 'beneficii cont client', 'cont VIP textile casă', 
    'avantaje cont client magazin online', 'creare cont pentru oferte speciale', 
    'înregistrare rapidă cumpărături textile', 'cont personalizat pentru comenzi', 
    'ofertă specială pentru clienți înregistrați', 'cont nou, livrare gratuită', 
    'înregistrează-te pentru a comanda perdele', 'cont special pentru textile premium', 
    'autentificare și reduceri instant', 'crează cont pentru a vedea prețurile exclusive', 
    'cont client fidelitate magazin textile', 'program de loialitate cont client', 
    'cont premium pentru cumpărături online', 'cont utilizator pentru comenzi rapide', 
    'cont client comenzi mai rapide', 'înregistrare cont și retururi ușoare', 
    'cont membru cumpărături online', 'cont premium decor interior', 'înregistrează-te pentru promoții',
    'cumpărături rapide cont client', 'înregistrează-te și salvează adrese de livrare',
    'înregistrare cont pentru urmărirea comenzilor', 'cont client cu opțiuni personalizate',
    'creare cont cu reducere la prima comandă', 'înregistrare simplă și rapidă',
    'create account online store', 'sign up for exclusive discounts', 'register now save money', 
    'new account special offers', 'exclusive benefits for registered users', 'VIP membership home textiles', 
    'register for personalized shopping', 'sign up to access premium products', 
    'quick registration online shopping', 'user account for fast orders', 'sign up for free shipping', 
    'exclusive deals for registered customers', 'register now to buy curtains online', 
    'premium membership home decor', 'instant access to special discounts', 'sign up to see exclusive prices', 
    'customer loyalty account program', 'personalized user account shopping', 
    'premium account for online shopping', 'fast checkout with registered account', 
    'register now for easy returns', 'member-only shopping benefits', 'sign up to track orders', 
    'sign up and save delivery addresses', 'join now for personalized offers', 'sign up for interior decor deals', 
    'quick and easy account registration', 'first order discount for new members', 
    'VIP customer benefits for home textiles'
  ],
