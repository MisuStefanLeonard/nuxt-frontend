...
const getSetData =  async () => {
    ...
    useHead({
        title : `Texx - ${setData.value.numeSetDto}`,
        link : [
            {rel: 'dns-prefetch' , href: 'https://dw45vxtt6tooj.cloudfront.net'},
            {rel: 'preconnect' , href: 'https://dw45vxtt6tooj.cloudfront.net'},
        ],
        keywords : [
        `seturi de perdele și draperii pentru dormitor`,
            `pachete elegante pentru decor interior`,
            `seturi de textile pentru casă`,
            `seturi de lenjerie și draperii asortate`,
            `seturi de amenajare pentru dormitor complet`,
            `pachete de lenjerie cu perne și cuverturi`,
            `seturi moderne pentru redecorare rapidă`,
            `pachete de lux pentru camere de hotel`,
            `seturi exclusive pentru design interior`,
            `pachete premium pentru casă`,
            `seturi de perdele și draperii opace`,
            `seturi blackout pentru odihnă optimă`,
            `pachete cu perne ergonomice și draperii`,
            `seturi termoizolante cu perdele duble`,
            `pachete economice cu perdele și cuverturi`,
            `seturi de bumbac pentru un somn odihnitor`,
            `pachete personalizate pentru dormitor`,
            `seturi cu materiale anti-alergice`,
            `pachete cu perdele și perne pentru copii`,
            `seturi rustice cu perdele și draperii vintage`,
            `pachete de lux cu broderii fine`,
            `seturi de lenjerie pentru hoteluri și pensiuni`,
            `pachete minimaliste pentru apartamente moderne`,
            `seturi cu perdele pentru case smart`,
            `pachete de decor premium pentru vile`,
            `seturi de vară cu perdele răcoroase`,
            `pachete de iarnă cu perdele groase`,
            `seturi impermeabile cu perdele speciale`,
            `pachete de decor pentru spa și centre wellness`,
            `seturi elegante pentru reamenajare`,
            `pachete de reîmprospătare a casei`,
            `seturi de textile anti-mucegai`,
            `pachete pentru reamenajare rapidă`,
            `seturi exclusive cu țesături de calitate`,
            `pachete cu perdele controlate prin aplicație`,
            `seturi de redecorare pentru spații comerciale`,
            `pachete cu perdele și draperii în stil clasic`,
            `seturi de amenajare pentru case de vacanță`,
            `pachete pentru birouri și spații moderne`,
            `seturi cu perdele și draperii termoizolante`,
            `pachete pentru reducerea zgomotului cu draperii fonice`,
            `seturi cu perdele decorative pentru living`,
            `pachete vintage pentru amenajări rafinate`,
            `seturi de perdele și perne anti-praf`,
            `pachete exclusive cu materiale eco-friendly`,
            `seturi pentru camera copiilor`,
            `pachete de lux pentru dormitor matrimonial`,
            `seturi de amenajare pentru case smart`,
            `pachete cu perdele satinate pentru un look elegant`,
            `seturi de textile cu imprimeuri florale`,
            `pachete complete pentru protecția solară`,
            `seturi cu perdele și draperii ușor de întreținut`,
            `seturi de lux pentru dormitor`,
            `seturi premium pentru casă`,
            `pachete complete pentru decor interior`,
            `seturi decorative pentru dormitor`,
            `seturi de pat cu perdele și draperii`,
            `pachete cu perne și cuverturi`,
            `seturi elegante de perdele și draperii`,
            `seturi de decor pentru living`,
            `seturi complete cu draperii și perdele`,
            `seturi moderne pentru amenajarea casei`,
            `pachete economice cu perdele și draperii`,
            `seturi de design interior pentru hoteluri`,
            `pachete de lux cu perdele și cuverturi`,
            `seturi de perne și cuverturi din bumbac`,
            `seturi termoizolante cu perdele blackout`,
            `pachete confortabile pentru dormitor`,
            `seturi personalizate cu draperii și perne`,
            `seturi pentru sezon rece cu cuverturi călduroase`,
            `seturi pentru vară cu perdele răcoroase`,
            `seturi anti-alergice cu perne speciale`,
            `seturi vintage cu perdele și draperii din catifea`,
            `pachete rezistente la pete pentru uz zilnic`,
            `seturi smart home cu perdele motorizate`,
            `seturi pentru hoteluri cu perne ergonomice`,
            `pachete rustice cu draperii și cuverturi`,
            `seturi de perne decorative pentru living`,
            `seturi premium pentru case de vacanță`,
            `seturi lavabile pentru dormitor`,
            `pachete eco-friendly cu textile naturale`,
            `seturi exclusive pentru design interior`,
            `seturi elegante cu perdele și broderie`,
            `pachete cu perne, draperii și cuverturi`,
            `seturi de amenajare pentru apartamente moderne`,
            `seturi cu efect blackout pentru odihnă optimă`,
            `pachete de relaxare cu perne și cuverturi moi`,
            `seturi pentru spații comerciale și birouri`,
            `pachete de lux pentru hoteluri și pensiuni`,
            `seturi clasice cu perdele și draperii`,
            `seturi pentru dormitor minimaliste`,
            `pachete all-in-one pentru reamenajare rapidă`,
            `seturi pentru călătorii cu perne compacte`,
            `pachete pentru reducerea zgomotului cu draperii fonice`,
            `seturi pentru copii cu perdele și perne personalizate`,
            `pachete ieftine online pentru reînnoirea casei`,
            `seturi exclusive cu țesături premium`,

            // English keywords
            `curtain and drape sets for bedrooms`,
            `elegant bundles for interior decor`,
            `home textile sets`,
            `bedding and curtain matching sets`,
            `full bedroom decor packages`,
            `bedding packages with pillows and bedspreads`,
            `modern home redecoration sets`,
            `luxury hotel room textile bundles`,
            `exclusive interior design sets`,
            `premium home textile bundles`,
            `curtain and drape sets with blackout effect`,
            `thermal insulating curtain and drape sets`,
            `economic bundles with drapes and bedspreads`,
            `cotton bedding sets for ultimate comfort`,
            `customized bedroom decor packages`,
            `hypoallergenic curtain and pillow sets`,
            `kids’ room curtain and pillow packages`,
            `rustic home decor bundles with vintage drapes`,
            `luxury packages with embroidered curtains`,
            `hotel and guesthouse bedding and curtain sets`,
            `minimalist decor bundles for modern apartments`,
            `smart home curtain packages`,
            `premium decor sets for vacation homes`,
            `summer-ready curtain and drape sets`,
            `winter-ready thick curtain bundles`,
            `waterproof curtain and drape sets`,
            `spa and wellness textile bundles`,
            `elegant redecoration packages`,
            `home refresh textile bundles`,
            `anti-mold curtain and bedspread sets`,
            `quick home makeover sets`,
            `exclusive bundles with high-quality fabrics`,
            `smart curtain sets with app control`,
            `commercial space redecoration packages`,
            `classic-style curtain and drape bundles`,
            `vacation home decor sets`,
            `office and modern space styling bundles`,
            `thermal insulating curtain packages`,
            `noise-reducing drapery bundles`,
            `decorative curtain and pillow sets for living rooms`,
            `vintage decor bundles for refined interiors`,
            `anti-dust curtain and pillow packages`,
            `eco-friendly home textile sets`,
            `kids’ bedroom textile sets`,
            `luxury bedding and drapery sets for master bedrooms`,
            `smart home decoration bundles`,
            `satin curtain sets for an elegant look`,
            `floral print curtain and bedspread bundles`,
            `full sun-protection curtain packages`,
            `easy-maintenance curtain and textile sets`,
            `modern interior styling bundles`,
            `budget-friendly home textile packages`,
            `soft and plush pillow and bedding sets`,
            `commercial-grade textile bundles for businesses`,
            `tailor-made curtain and drapery packages`,
            `full house makeover sets with textiles`,
            `designer-curated decor bundles`,
            `quick-install curtain and bedding packages`
            `luxury bedroom sets`,
            `premium home decor bundles`,
            `complete interior decor packages`,
            `decorative bedroom sets`,
            `bedding sets with curtains and drapes`,
            `bundles with pillows and bedspreads`,
            `elegant curtain and drape sets`,
            `living room decor sets`,
            `full curtain and drapery sets`,
            `modern home styling bundles`,
            `affordable curtain and drape packages`,
            `interior design sets for hotels`,
            `luxury bundles with curtains and bedspreads`,
            `cotton pillow and bedspread sets`,
            `thermal insulation bundles with blackout curtains`,
            `cozy bedroom comfort packages`,
            `custom pillow and drapery sets`,
            `cold-season bundles with warm bedspreads`,
            `summer-ready sets with breathable curtains`,
            `anti-allergic pillow and curtain sets`,
            `vintage bundles with velvet drapes and curtains`,
            `stain-resistant home sets for everyday use`,
            `smart home sets with motorized curtains`,
            `ergonomic pillow and curtain bundles for hotels`,
            `rustic home decor sets with drapes and bedspreads`,
            `decorative pillow sets for living rooms`,
            `premium home bundles for vacation houses`,
            `washable bedroom textile sets`,
            `eco-friendly sets with natural fabrics`,
            `exclusive interior design bundles`,
            `elegant bundles with embroidered curtains`,
            `bundles including pillows, drapes, and bedspreads`,
            `modern apartment styling packages`,
            `blackout-effect bedroom sets for restful sleep`,
            `relaxation packages with soft pillows and bedspreads`,
            `office and commercial space decor bundles`,
            `luxury hospitality textile packages`,
            `classic drape and curtain sets`,
            `minimalist bedroom styling sets`,
            `all-in-one redecoration bundles`,
            `travel-friendly sets with compact pillows`,
            `noise-reducing drapery bundles for peaceful sleep`,
            `kids bedroom sets with personalized curtains and pillows`,
            `affordable online bundles for home renovation`,
            `exclusive bundles with premium fabrics`
        ],
        siteName : `Texx - ${setData.value.numeSetDto}`,
        canonicalUrl : `http://localhost:3000/${encodedIdSet}/${setData.value.numeSetDto}`,
