...
const menuItems = [
  { title: 'menu.home', path: '/home', icon: 'mdi-home' },
  { title: 'menu.about', path: '/about', icon: 'mdi-account-box' },
  { title: 'menu.contact', path: '/contact', icon: 'mdi-information' },
]

const menuItems2 = ref([
{ title: 'menu.profile' , path: '/user/profile' , icon: 'mdi-account' , dropdown : []},
  { 
    title: 'menu.shop', 
    path: '/shop', 
    icon: 'mdi-store',
